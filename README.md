...
| 이름  | 역할  | 담당 영역 |
|:-----:|:------|:----------|
| [김현호](https://github.com/smthswt) | 파이프라인 | 프론트엔드 설계 및 개발, 백엔드 설계 |
| [임종혁](https://github.com/2000may24th) | 파이프라인 | 크롬 확장 구현, API 연동 |
| [조윤영](https://github.com/younyoungieo) | 파이프라인 | 기획, OAuth 인증, 백엔드 설계 및 배포 |
| [김예진](https://github.com/gina261) | 모델링 | BERT 및 세부 분류 모델 구축 |
